...
APPARATUS_PATHS = (
    ...
    "harness.py", "persistence.py", "retrieval.py", "c48.py", "append_calibration.py", "d96.py", "d96_terminal.py", "thinking_probe.py", "thinking_bridge.py", "thinking_temporal.py", "thinking_no_idle_bridge.py", "corpus.py",

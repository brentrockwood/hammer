...
| Thinking no-idle bridge | 1K-cap configuration abort recorded; 4K-cap member frozen | A representation-unspecified but explicitly solicited bridge removes the earlier forced-idle interval and tests support-versus-final-output semantics. |

...
| Thinking temporal-sequencing control | Frozen, not yet run | An explicit checkpoint crosses transcript loss without the ladder's forced idle interval. It is a protocol control, not externalization evidence. |

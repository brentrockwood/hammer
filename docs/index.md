...
| Thinking no-idle bridge | Bridge semantic calibration complete | After a grammar and fixed-turn failure, the close-triggered 4K-cap member created, rediscovered, read, and used a self-named support file across transcript loss. It remains explicitly solicited calibration. |

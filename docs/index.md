...
| Thinking checkpoint positive control | Frozen calibration; no run yet | A required checkpoint round trip tests thinking-field continuity and adapter-visible filesystem lineage. |
...
11. [Thinking-response positive control](thinking-positive-control-protocol.md) — the explicit checkpoint calibration for native reasoning continuity.
